...
using namespace CppCAN::parsing::dbc;
namespace dtl = CppCAN::parsing::details;

static std::string VERSION_TOKEN = "VERSION";
static std::string NS_SECTION_TOKEN1 = "NS_";
static std::string NS_DESC_SECTION_TOKEN = "NS_DESC_";
static std::string NS_SECTION_TOKEN2 = "_NS";
static std::string SG_MULVAL_TOKEN = "SG_MUL_VAL_";
...
static std::set<std::string> SUPPORTED_DBC_TOKENS = {
  VERSION_TOKEN, NS_DESC_SECTION_TOKEN, BIT_TIMING_TOKEN, NODE_DEF_TOKEN,
  MESSAGE_DEF_TOKEN, SIG_DEF_TOKEN, SIG_VAL_DEF_TOKEN, ENV_VAR_TOKEN,
  COMMENT_TOKEN, ATTR_DEF_TOKEN, ATTR_DEF_DEFAULT_TOKEN, ATTR_VAL_TOKEN,
  SG_MULVAL_TOKEN
};
...
static std::set<std::string> NS_TOKENS = {
  ...
  "SIGTYPE_VALTYPE_", "SG_MUL_VAL_", "BO_TX_BU_", "BA_DEF_REL_", "BA_REL_", "BA_DEF_DEF_REL_", 
...
CppCAN::CANDatabase 
CppCAN::parsing::dbc::fromTokenizer(dtl::Tokenizer& tokenizer, 
...
CppCAN::CANDatabase
CppCAN::parsing::dbc::fromTokenizer(const std::string& name, dtl::Tokenizer& tokenizer, std::vector<CppCAN::CANDatabase::parsing_warning>* warnings) {
